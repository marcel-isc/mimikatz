...
typedef struct _KIWI_MSV1_0_LIST_61_ANTI_MEMADOG {
	struct _KIWI_MSV1_0_LIST_61_ANTI_MEMADOG *Flink;
	struct _KIWI_MSV1_0_LIST_61_ANTI_MEMADOG *Blink;
	PVOID unk0;
	ULONG unk1;
	PVOID unk2;
	ULONG unk3;
	...
	ULONG unk22;
	PVOID CredentialManager;
} KIWI_MSV1_0_LIST_61_ANTI_MEMADOG, *PKIWI_MSV1_0_LIST_61_ANTI_MEMADOG;
